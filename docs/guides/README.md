...
- `PARSER_DEVELOPMENT.md` – How to scaffold and register a new `data.parse.*` + schema pair (`parser_scaffold`, executor wiring, docs).
...
> When adding a new guide, drop it in this directory and add a one-line summary here.
